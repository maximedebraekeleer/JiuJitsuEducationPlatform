    ...
    public class DataInitializer
    {
        ...
        public async Task InitializeData()
        {
            ...
            if (_dbContext.Database.EnsureCreated())
            {
                ...
                //--Commentaar
                _dbContext.Commentaren.Add(new Commentaar("nieuwe comment", (Lid)lid1, lm2));
                _dbContext.Commentaren.Add(new Commentaar("nog een comment", (Lid)lid1, lm2));
                _dbContext.Commentaren.Add(new Commentaar("derde comment", (Lid)lid2, lm2));
